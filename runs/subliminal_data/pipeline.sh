...
# Slurm pipeline for subliminal data-effects experiments (DPO + LLS subsets).
...
SELECT_BATCH_SIZE="${SELECT_BATCH_SIZE:-256}"
...
BETAS="${BETAS:-0.01 0.02 0.04 0.08}"
