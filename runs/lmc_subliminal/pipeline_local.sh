...
PRETRAIN_DEVICE_BATCH_SIZE="${PRETRAIN_DEVICE_BATCH_SIZE:-256}"
...
SFT_DEVICE_BATCH_SIZE="${SFT_DEVICE_BATCH_SIZE:-128}"
SFT_SAVE_EVERY="${SFT_SAVE_EVERY:--1}"

BASE_BETA="${BASE_BETA:-0.1}"
BASE_LR="${BASE_LR:-1e-6}"
BASE_TOTAL_PAIRS="${BASE_TOTAL_PAIRS:-256}"
BASE_DEVICE_BATCH_SIZE="${BASE_DEVICE_BATCH_SIZE:-128}"
...
STUDENT_TOTAL_PAIRS="${STUDENT_TOTAL_PAIRS:-256}"
STUDENT_DEVICE_BATCH_SIZE="${STUDENT_DEVICE_BATCH_SIZE:-128}"
